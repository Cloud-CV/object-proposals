function [segm_params, filepath_params, other_params] = ...
    params_SketchTokens(segm_params, filepath_params, other_params, ...
                        extra_params)
...
% @date:        Fall 2013 - Summer 2014
    ...
    sp = get_param_val(sp, ep, 'boundaries_method',     'SketchTokens');
    ...
    sp = get_param_val(sp, ep, 'graph_pairwise_sigma',        {                  4                  ,                   4                  });
