...
img_names = textread('./Lefts_SketchTokens.txt','%s');
...
for k=1:10
    ...
    file_params.data_save_dirpath = ['/export/scratch/fuxin/RunAhmadVOC/SketchTokens_' num2str(k) '/'];
    segm_params.boundaries_method = 'SketchTokens';
...
%    the_quality_dir = ['/export/scratch/fuxin/RunAhmadVOC/SketchTokens_' num2str(k) '/SegmentEval/overlap/'];
