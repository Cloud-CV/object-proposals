function [superPixSeg,superPixInd,superPixBounds]=mvg_FelzenswalbSuperpixelWrapper(img,sigma,min_area,k, rahtuPath)
...
soft_dir=[rahtuPath,'/segment/']; % Change here the path to the executables
