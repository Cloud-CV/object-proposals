function printOcclusionResultWithContact(im, bndinfo, lab, fn, contact, fignum)
...
displayOcclusionResult(im, bndinfo, objlab, lab, contact, fignum);
set(gcf, 'PaperPositionMode', 'auto');
%print(['-f' num2str(fignum)], '-djpeg80', fn); 
