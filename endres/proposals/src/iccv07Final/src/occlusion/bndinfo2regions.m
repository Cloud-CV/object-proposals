function [regions, scores] = bndinfo2regions(bndinfo, imname, niter, maxov, nr)
% [regions, scores] = bndinfo2regions(bndinfo, imname, niter, maxov, nr)
%
DO_DISPLAY = 0;
...
if numel(classifier.w)<6
    x = getBoundaryFeatures(ind, occ);
else
