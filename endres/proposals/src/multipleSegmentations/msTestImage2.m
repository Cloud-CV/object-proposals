function [pg, data, imsegs] = msTestImage2(im, imsegs, classifiers, nsegments, normalize, ...
...
% if imsegs is a cell, it contains the parameters to Felz segmentation to make the
